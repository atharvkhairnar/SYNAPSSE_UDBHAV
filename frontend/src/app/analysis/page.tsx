...
export default function AnalysisPage() {
  ...
  const verdict =
    loans > 0
      ? "Prioritize loan closure first, keep emergency reserve active, then begin SIP investments."
      : "No major debt detected. Start monthly SIP growth plan immediately.";
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-white/5 border border-white/10 rounded-3xl p-6">
            ...
            <p className="text-gray-300">
              Monthly free cashflow of ₹{freeCash}. Invest early for compounding returns.
            </p>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-3xl p-6">
            ...
            <p className="text-gray-300">
              Total debt of ₹{loans}. Build reserve and reduce liabilities first.
            </p>
          </div>
